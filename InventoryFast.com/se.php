...
<a href='navPage.php'><button>Back to Main Menu</button></a>
...
<input type="text" id="barWidth" value="1" size="2">
<br />
bar height:
...
<canvas id="canvasTarget" width="5000px" height="150"></canvas>
<button onclick="myFunction()">Print Barcode</button>
